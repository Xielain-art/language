...
## Свободный диалог
free-chat-activated = 💬 Режим свободного диалога активирован!\n\nОтправь мне текст или голосовое сообщение. Я всегда буду отвечать текстом.
menu-free-chat = 💬 Свободный диалог
...
voice-chat-thinking = Слушаю и думаю... 🧠

stats-progress-title = Твой путь к следующему уровню:
stats-mistakes-progress = Ошибки: { $count } / { $min }
stats-reports-progress = Отчеты: { $count } / { $min }
stats-mega-ready = Отлично! Ты готов к сдаче Мега-отчета (Экзамена). Нажми кнопку ниже!
stats-report-ready = Накоплено достаточно ошибок. Можно сгенерировать отчет!
stats-level-up-suggestion = 🎉 Судя по твоему прогрессу, ты готов к переходу на следующий уровень!
stats-level-up-btn = 🎓 Сдать экзамен

## Голосовой чат
menu-voice-chat = 📞 Голосовой чат 🔒
voice-chat-activated = 🎙 <b>Голосовой чат активирован!</b>\n\nОтправляй мне голосовые сообщения, и я буду отвечать голосом. Текстовые сообщения тоже принимаются!

## Повышение уровня
menu-level-up = 🎓 Повысить уровень (Экзамен)
roleplay-locked = 🔒 Этот сценарий доступен с уровня { $level }. Пройдите экзамен, чтобы разблокировать!
